...
maps.each do |m|
  bots.each do |b|
    ...
    debug = `java -jar engine/Tron.jar maps/#{m} "./MyTronBot" "java -jar example_bots/#{b}" 0 1`
    result = debug.split("\n").last
    ...
    debug = `java -jar engine/Tron.jar maps/#{m} "java -jar example_bots/#{b}" "./MyTronBot" 0 1`
    result = debug.split("\n").last
