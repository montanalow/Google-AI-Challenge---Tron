...
namespace zz {
  ...
  private:
    ...
    zz::map _map, _apocalyptic, _big_room, _center, _divider, _joust, _keyhole, _medium_room, _playground, _quadrant, _ring, _toronto, _trix, _u;
  };

  void looped_minimax(int mins[], int& max, const zz::map& map, int iterations);
